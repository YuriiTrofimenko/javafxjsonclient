 ...
 */
package org.tyaa.javafxjsonclient;
...
public class CustomerMessageBodyReader implements MessageBodyReader<List<Customer>> {
    ...
    @Override
    public List<Customer> readFrom(Class<List<Customer>> type, java.lang.reflect.Type type1, Annotation[] antns, MediaType mt, MultivaluedMap<String, String> mm, InputStream in) throws IOException, WebApplicationException {
